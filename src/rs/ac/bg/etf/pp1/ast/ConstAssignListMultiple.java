...
public class ConstAssignListMultiple extends ConstAssignList {

    private ConstAssignList ConstAssignList;
    private ConstAssign ConstAssign;

    public ConstAssignListMultiple (ConstAssignList ConstAssignList, ConstAssign ConstAssign) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("ConstAssignListMultiple(\n");
