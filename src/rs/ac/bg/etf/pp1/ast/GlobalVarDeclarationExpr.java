...
public class GlobalVarDeclarationExpr extends GlobalVarDecl {

    private Type Type;
    private GlobalVarDeclList GlobalVarDeclList;

    public GlobalVarDeclarationExpr (Type Type, GlobalVarDeclList GlobalVarDeclList) {
        this.Type=Type;
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("GlobalVarDeclarationExpr(\n");
